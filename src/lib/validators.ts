...
export const transactionSchema = z
  .object({
    ...
    status: z.enum(["PENDING", "COMPLETED", "CANCELLED", "PLANNED"]).default("PENDING"),
...
export const partialTransactionFieldSchema = z.object({
  ...
  subCategoryId: z.string().nullable().optional(),
  bucketId: z.string().nullable().optional(),
  status: z.enum(["PENDING", "COMPLETED", "CANCELLED", "PLANNED"]).optional(),
  note: z.string().nullable().optional(),
...
const exportTransactionSchema = z.object({
  ...
  month: z.number(),
  year: z.number(),
  status: z.enum(["PENDING", "COMPLETED", "CANCELLED", "PLANNED"]),
