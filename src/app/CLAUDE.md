...
| `/savings` | Vue annuelle des comptes épargne/investissement | `?year=2026` |
| `/statistics` | Graphiques et analyses | `?year=2026&account=xxx` |
| `/settings` | Réglages (token API, préférences, export/import) | - |
| `/admin` | Administration (liste utilisateurs, stats globales) -- `requireAdmin()` | - |
| `/transactions/print` | Vue impression du mois | `?month=2026-02` |
