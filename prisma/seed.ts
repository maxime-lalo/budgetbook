...
async function main() {
  ...
  const sampleTransactions = [
    ...
    { label: "Virement épargne", amount: -500, date: new Date(currentYear, currentMonth, 2), month, year: currentYear, status: "COMPLETED" as const, accountId: checking.id, categoryId: getCatId("Épargne"), subCategoryId: getSubId("Épargne", "Livret A"), destinationAccountId: savings.id, bucketId: "bucket-emergency" },
